    ...
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>My Balance</h4><p id="balance">Ksh. <?php echo $balance ?></p></center></td>
        </tr>
      </table>
    </td>
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>Total Limit</h4><p id="tlimit">Ksh. <?php echo $online_limit + $card_limit ?></p></center></td>
        </tr>
      </table>
    </td>
  </tr>
    ...
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>Online Transaction Limit</h4><p id="olimit">Ksh. <?php echo $online_limit ?></p></center></td>
        </tr>
      </table>
    </td>
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>Card Limit</h4><p id="climit">Ksh. <?php echo $card_limit ?></p></center></td>
        </tr>
      </table>
    </td>
  </tr>
